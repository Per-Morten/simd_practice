...
// Per-Morten Straume: Change of namespace + various optimizations to practice optimizing.

#define OPTIMIZED_REPARAMETERIZE
#define OPTIMIZED_GENERATEBEZIER
#define OPTIMIZED_GENERATEBEZIERSIMD
#define OPTIMIZED_FINDMAXSQUAREDERROR
#define OPTIMIZED_GETRIGHTTANGENT
#define OPTIMIZED_GETLEFTTANGENT
...
namespace CurvesOptimized
{
    ...
    {
        public const FLOAT EPSILON = VectorHelper.EPSILON;  // below this, we can't trust floating point values
        public const int MAX_ITERS = 4;                     // maximum number of iterations of newton's method to run before giving up and splitting curve
        public const int END_TANGENT_N_PTS = 8;             // maximum number of points to base end tangent on
        public const int MID_TANGENT_N_PTS = 4;             // maximum number of points on each side to base mid tangent on

        /// <summary>
        /// Points in the whole line being used for fitting.
        /// </summary>
        public readonly List<VECTOR> _pts = new List<VECTOR>(256);
        ...
        /// </summary>
        public readonly List<FLOAT> _arclen = new List<FLOAT>(256);
        ...
        /// curve.
        /// </summary>
        public readonly List<FLOAT> _u = new List<FLOAT>(256);
        ...
        static Unity.Profiling.ProfilerMarker FitCurveMarker = new Unity.Profiling.ProfilerMarker("FitCurve");
        ...
        static Unity.Profiling.ProfilerMarker GetLeftTangentMarker = new Unity.Profiling.ProfilerMarker("GetLeftTangent");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker GetRightTangentMarker = new Unity.Profiling.ProfilerMarker("GetRightTangent");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker GetCenterTangentMarker = new Unity.Profiling.ProfilerMarker("GetCenterTangent");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker ArcLengthParamaterizeMarker = new Unity.Profiling.ProfilerMarker("ArcLengthParamaterize");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker GenerateBezierMarker = new Unity.Profiling.ProfilerMarker("GenerateBezier");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker ReparameterizeMarker = new Unity.Profiling.ProfilerMarker("Reparameterize");
        /// <summary>
        ...
        static Unity.Profiling.ProfilerMarker FindMaxSquaredErrorMarker = new Unity.Profiling.ProfilerMarker("FindMaxSquaredError");
        /// <summary>
