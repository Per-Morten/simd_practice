...
namespace RGBToRGBAFloat4Tests
{
    public class Tests
    {
        ...
        public class Correctness
        {
            ...
            {
                protected Func<List<u8>, List<float4>> Func;
                ...
                private unsafe void RunTest(Color color)
                {
                    ...
                    for (int i = 0; i < colors.Count; i++)
                        Assert.IsTrue(math.all(aprox(colors[i], target)));
                }
            ...
            public class Burst : GenericTests
            {
                ...
                {
                    base.Setup();
                    Func = RGBToRGBAFloat4.BurstForLoop;
                }
            }
            ...
            public class V128ForLoop : GenericTests
            {
                ...
                {
                    base.Setup();
                    Func = RGBToRGBAFloat4.V128ForLoop;
                }
            }
            ...
            public class V256ForLoop : GenericTests
            {
                ...
                {
                    base.Setup();
                    Func = RGBToRGBAFloat4.V256ForLoop;
                }
            }
        }
#endif
