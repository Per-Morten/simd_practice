...
namespace CurvesOptimized
{
    ...
    public sealed class CurveBuilder : CurveFitBase, IEnumerable<CubicBezier>
    {
        ...
        public int _first;                                              // Index of first point in current curve
        ...
        static Unity.Profiling.ProfilerMarker AddPointMarker = new Unity.Profiling.ProfilerMarker("AddPointDoWhileLoop");
        static Unity.Profiling.ProfilerMarker AddPointDoWhileLoopMarker = new Unity.Profiling.ProfilerMarker("AddPointDoWhileLoop");
        ...
        static Unity.Profiling.ProfilerMarker AddInternalMarker = new Unity.Profiling.ProfilerMarker("AddInternal");
